...
app.use(cors({
  origin: ['http://xenoxil.mesto.nomoredomains.icu', 'http://xenoxil.mesto.nomoredomains.icu', 'https://xenoxil.mesto.nomoredomains.icu/sign-in', 'https://xenoxil.mesto.nomoredomains.icu/sign-up'],
  credentials: true,
}));
